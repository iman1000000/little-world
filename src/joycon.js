...
joycon = {
    ...
    get leftAxisX() {
        ...
        let down = window.game.input.keyboard.isDown(Phaser.Keyboard.DOWN);
        let left = window.game.input.keyboard.isDown(Phaser.Keyboard.LEFT);
        let right = window.game.input.keyboard.isDown(Phaser.Keyboard.RIGHT);
    ...
    p2: {
        get axisX() {
            let up = window.game.input.keyboard.isDown(Phaser.Keyboard.I);
            let down = window.game.input.keyboard.isDown(Phaser.Keyboard.K);
            let left = window.game.input.keyboard.isDown(Phaser.Keyboard.J);
            let right = window.game.input.keyboard.isDown(Phaser.Keyboard.L);
